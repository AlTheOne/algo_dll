...
from src.exceptions import InvalidNextIdException
from src.manager import DllManager
from src.nodes import Node


class TestDllManagerMoveNode:

    def test_dll_filled_when_move_last_node_to_first(
            self,
        ...
        dll_manager_empty.move_node(node=node0, next_node=node1)
    ...
    def test_dll_filled_when_move_first_node_to_last(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        ...
        dll_manager_empty.move_node(node=node4)
    ...
    def test_dll_filled_when_move_first_node_to_middle(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        node3: Node = Node(node_id=3)
        ...
        dll_manager_empty.move_node(node=node3, next_node=node4)
    ...
    def test_dll_filled_when_move_last_node_to_middle(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        node1: Node = Node(node_id=1)
        ...
        dll_manager_empty.move_node(node=node2, next_node=node3)
    ...
    def test_dll_filled_when_move_middle_node_to_middle(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        node1: Node = Node(node_id=1)
    ...
    def test_dll_when_two_node_replaced(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        node2: Node = Node(node_id=2)
        ...
        dll_manager_empty.move_node(node=node2)
    ...
    def test_dll_when_move_node_to_self(
            self,
            dll_manager_empty: DllManager,
    ) -> None:
        node1: Node = Node(node_id=1)
        ...
        with pytest.raises(InvalidNextIdException):
            dll_manager_empty.move_node(node=node2, next_node=node2)
